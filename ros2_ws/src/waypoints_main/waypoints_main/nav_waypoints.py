...
def main():
    ...
    special_distance_threshold = 0.2  # Smaller distance threshold for the special waypoint
    ...
    for i, waypoint in enumerate(waypoints):
        ...
        while not nav.isTaskComplete():
            feedback = nav.getFeedback()
            current_pose = nav.getCurrentPose()
            
            # Use different distance thresholds based on the waypoint index
